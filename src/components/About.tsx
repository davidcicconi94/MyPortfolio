  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div>
          <p className="sm:text-4xl md:text-2xl text-base font-bold inline border-b-2 border-red-700">
            Acerca
          </p>
        </div>
        ...
        <p className="sm:text-4xl md:text-2xl text-base mt-5">
          ...
          <p className=" sm:text-4xl md:text-2xl text-base mt-5">
            ...
            <p>
              En medio de mi cursada, fui elegido por el staff de Henry como{" "}
